...
type Agent struct {
	...
	Capabilities []Capability `protobuf:"varint,4,rep,packed,name=capabilities,proto3,enum=llm.v1.Capability" json:"capabilities,omitempty"`
...
type Tool struct {
	...
	Type        ToolType `protobuf:"varint,3,opt,name=type,proto3,enum=llm.v1.ToolType" json:"type,omitempty"`
}
...
var file_agent_v1_agent_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x2a, 0xbf, 0x01, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62,
	...
	0x45, 0x5f, 0x54, 0x41, 0x53, 0x4b, 0x10, 0x06, 0x2a, 0x25, 0x0a, 0x08, 0x54, 0x6f, 0x6f, 0x6c,
	...
	0x8c, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31,
	0x42, 0x0a, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2f,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x68, 0x69, 0x61, 0x61,
	0x79, 0x61, 0x63, 0x68, 0x69, 0x2f, 0x74, 0x69, 0x6e, 0x79, 0x6d, 0x65, 0x73, 0x68, 0x2f, 0x61,
...
var file_agent_v1_agent_proto_goTypes = []any{
	(Capability)(0), // 0: llm.v1.Capability
	(ToolType)(0),   // 1: llm.v1.ToolType
	(*Agent)(nil),   // 2: llm.v1.Agent
	(*Tool)(nil),    // 3: llm.v1.Tool
}
var file_agent_v1_agent_proto_depIdxs = []int32{
	0, // 0: llm.v1.Agent.capabilities:type_name -> llm.v1.Capability
	3, // 1: llm.v1.Agent.tools:type_name -> llm.v1.Tool
	1, // 2: llm.v1.Tool.type:type_name -> llm.v1.ToolType
